...
library(threejs)
library(htmlwidgets)
J3 <- scatterplot3js(df$MonthlyCharges, df$TotalCharges, df$tenure,
color = c("red", "blue", "yellow")[df$InternetService],size = 0.1, 
axisLabels=c("Monthly charges","tenure period","Total charges"), grid = TRUE,
main = "Tenure groups with Numeric variables")
saveWidget(J3, file="Telcom Customer Internet Services Type 3D.html", selfcontained = TRUE, libdir =
